...
const Page2 = () => {
  ...
  return (
    <div id="section-2" className="bg-white text-center text-black ">
      <h4 className="text-2xl text-[#717171] font-[anzo2]">
        © Soban.Dev 2024 | designed and developed
      </h4>
      <div id="rotate-text" className="mt-60">
        <h1 className="text-[45vw] font-[anzo4] leading-[35vw] uppercase">
          IMPACTFUL
        </h1>
      </div>
